...
public class MasterTemplateController {
    ...
    @Log(title = "模板模块",operation = "添加模板信息",operatorType = OperatorType.MOBILE)
    ...
    @Log(title = "模板模块",operation = "查询模板信息列表(通过模板编号列表)",operatorType = OperatorType.MOBILE)
    ...
    @Log(title = "模板模块",operation = "查询模板信息",operatorType = OperatorType.MOBILE)
