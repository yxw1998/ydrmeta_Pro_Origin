...
public class ActivityController {
    ...
    @Log(title = "活动模块",operation = "添加业务活动信息",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "活动模块",operation = "查询业务活动信息(通过业务活动编号)",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "活动模块",operation = "添加扩展活动信息",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "活动模块",operation = "查询扩展活动信息(通过扩展活动编号)",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "活动模块",operation = "添加报名活动信息",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "活动模块",operation = "查询报名活动信息(通过报名活动编号)",operatorType = OperatorType.MANAGE)
