...
public class ApplyShortController {
    ...
    @Log(title = "报名临时模块",operation = "添加临时报名信息",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "报名临时模块",operation = "查询临时报名信息（通过用户编号）",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "报名临时模块",operation = "更新临时报名信息",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "报名临时模块",operation = "查询所有临时报名信息",operatorType = OperatorType.MANAGE)
