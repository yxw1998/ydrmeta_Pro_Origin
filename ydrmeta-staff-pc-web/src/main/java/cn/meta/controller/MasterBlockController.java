...
public class MasterBlockController {
    ...
    @Log(title = "模块模块",operation = "通过模板编号查询模块记录列表",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "模块模块",operation = "添加模块记录",operatorType = OperatorType.MANAGE)
    ...
    @Log(title = "模块模块",operation = "添加模块记录列表",operatorType = OperatorType.MANAGE)
